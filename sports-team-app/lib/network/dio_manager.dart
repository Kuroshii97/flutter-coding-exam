...
class DioManager {
  ...
  DioManager._internal() {
    ...
    option.baseUrl = 'https://www.thesportsdb.com/';
    option.connectTimeout = const Duration(milliseconds: 10000);
    option.receiveTimeout = const Duration(milliseconds: 10000);
